...
namespace TestTask1.Logic
{
    ...
    public class DataAPIOnlyBorrow : Task1.DataLayer.AbstractDataAPI
    {
    ...
    public class DataAPIOnlyReturn : Task1.DataLayer.AbstractDataAPI
    {

        private List<State> localstates = new List<State>();
        private List<User> localusers = new List<User>();
        private List<Catalog> localCatalog = new List<Catalog>();
        private List<Event> localEvent = new List<Event>();
